...
app.intent('Browse Carousel', response.browseCarousel)
...
function welcome (conv) {
  ...
  conv.ask(new Suggestions(['Simple Response', 'Basic Card', 'Browse Carousel', 'Surface checking', 'Ask for Permission', 'Ask for Date', 'Ask for Place', 'Ask for Sign in', 'Ask for confirmation', 'Can I get 1 ice tea', 'Daily content']))
